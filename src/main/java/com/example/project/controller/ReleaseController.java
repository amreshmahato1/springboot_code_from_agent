...
public class ReleaseController {
    ...
    public ResponseEntity<AssociationResponseDto> associateReleaseWithMilestone(
            @PathVariable Long releaseId,
            @PathVariable Long milestoneId) {
        AssociationResponseDto response = associationService.linkReleaseToMilestone(releaseId, milestoneId);
